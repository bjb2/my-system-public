...
4. **Flag for review**: If you're unsure what to do with an item (requires judgment, missing context, or risky to auto-process), write it to inbox/captures/needs-review-$(Get-Date -Format 'yyyy-MM-dd').md with a one-sentence reason.
