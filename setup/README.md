...
Add (adjust path for your OS):
```json
{
  "hooks": {
    "Stop": {
      "command": "python \"/Users/you/.claude/hooks/maintenance-check.py\"",
      "timeout": 5000
    }
  }
}
...
The hook auto-detects your org directory by decoding Claude's transcript path. If auto-detection fails, set an `ORG_DIR` environment variable pointing to your org root.
...
- [../ONBOARDING.md](../ONBOARDING.md) - Onboarding playbook
